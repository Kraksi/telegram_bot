...
'''Используемые алгоритмы из библиотеки fuzzywuzzy для вычесления максимально похожего вопроса'''
...
'''Основной алгоритм вычесления максимально похожего вопроса. 
   Создает список из вопросов и коэфицента схожести вопросов'''
...
'''Сортировка полученных после обработки основным алгоритмом вопросов, в соответствии с количесвом вопросов'''
...
'''Получение списка вопросов при помощи основного алгоритма и сортировки'''
...
'''Выделение самого популярного ответа'''
